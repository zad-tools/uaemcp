...
| Testing | 9/10 | 166 offline/runtime tests plus SDK and browser verification | Live authorities are intentionally not a deterministic CI gate |
...
| Preserve the original tool contract | Complete | 25 additive tools and compatibility assertions in `test/http.test.ts` |
