...
| MCP compliance | 9/10 | stdio and Streamable HTTP, 41 tools, fifteen static resources, two resource templates and three prompts | Compatibility must be retested on each SDK upgrade |
...
- National coverage cannot be manufactured: the registry currently separates 46
