...
The platform exposes twenty-three verified public products, but most research still
...
| --- | --- | --- |
| Cross-product research workflow | Twenty-three entries in `src/products.ts`; Evidence Studio composes bounded source-native evidence | P1 |
| Policy freshness monitoring | Complete in v1.67 across five audited official surfaces | Complete |
| Live national breadth | 47 indexed sources and fifteen live record connectors; Tourism Pulse adds 60 licensed annual observations across five national series | P1 |
...
1. Add licensed national live connectors beyond the current fifteen.
