...
the first `v1.66.0` tag, the `uaemcp` package owner must open the package settings
...
bun run check
git tag -s v1.66.0 -m "Open Emirates Intelligence v1.66.0"
git push origin v1.66.0
```
