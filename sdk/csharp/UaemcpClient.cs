...
public sealed class UaemcpClient {
 ...
 public Task<JsonDocument> GetObservatoryReport(IReadOnlyDictionary<string,string?>? parameters=null, CancellationToken cancellationToken=default)=>Get("/api/v1/observatory",parameters,cancellationToken);
 public Task<JsonDocument> ListObservatoryIncidents(IReadOnlyDictionary<string,string?>? parameters=null, CancellationToken cancellationToken=default)=>Get("/api/v1/observatory/incidents",parameters,cancellationToken);
 public Task<JsonDocument> GetObservatorySource(string SourceId, IReadOnlyDictionary<string,string?>? parameters=null, CancellationToken cancellationToken=default)=>Get("/api/v1/observatory/sources/" + Uri.EscapeDataString(SourceId) + "",parameters,cancellationToken);
