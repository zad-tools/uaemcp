...
impl UaemcpClient {
 ...
 pub async fn get_mcp_tool(&self, tool_name: &str, params: &[(&str,&str)]) -> Result<Value, reqwest::Error> { self.get(&format!("/api/v1/tools/{}", urlencoding::encode(tool_name)), params).await }
 pub async fn call_mcp_tool_from_playground(&self, tool_name: &str, params: &[(&str,&str)]) -> Result<Value, reqwest::Error> { self.get(&format!("/api/v1/tools/{}/call", urlencoding::encode(tool_name)), params).await }
 ...
 pub async fn get_employment_gender(&self, params: &[(&str,&str)]) -> Result<Value, reqwest::Error> { self.get(&format!("/api/v1/employment-gender"), params).await }
