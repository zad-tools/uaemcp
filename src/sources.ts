...
const MOET_TOURISM_2014_2025_XLSX = "https://www.moet.gov.ae/documents/20121/0/Copy+of+Copy+of+%D8%A8%D9%8A%D8%A7%D9%86%D8%A7%D8%AA+%D8%A7%D9%84%D8%B3%D9%8A%D8%A7%D8%AD%D8%A9+2014-2025.xlsx?download=true";
...
const BUILT_IN: Source[] = [
  src({ id: "mohre_employment_gender_2020_2024", name_en: "Employment by Gender 2020–2024", name_ar: "العمالة حسب النوع 2020–2024", owner: "Ministry of Human Resources and Emiratisation", category: "employment", kind: "xlsx", base_url: "https://www.mohre.gov.ae/assets/download/f13f2c67/Employment%20by%20Gender%202020%20-%202024_638941250942160725.xlsx.aspx", docs_url: "https://www.mohre.gov.ae/en/open-data/open-data-plan", license: "MOHRE Open Data Policy requires source attribution.", notes: "Official annual private-sector employee ratios by the source-published male/female categories. The ratios are not employee counts or a total for all UAE employment.", connector_config: { sheet: 2, header_row: 4, period: "2020-2024" } }),
  src({ id: "moet_tourism_2014_2025", name_en: "UAE Tourism Statistics 2014–2025", name_ar: "إحصاءات السياحة في الإمارات 2014–2025", owner: "UAE Ministry of Economy and Tourism", category: "tourism", kind: "xlsx", base_url: MOET_TOURISM_2014_2025_XLSX, docs_url: "https://www.moet.gov.ae/en/web/guest/moec-opendata", license: "MOET Open Data Guidelines permit viewing, reuse and sharing with attribution to the Ministry website.", notes: "The generic XLSX connector exposes the hotel-guest-arrivals sheet; the dedicated Tourism Pulse product validates all five annual metric sheets. Guest arrivals are not necessarily unique tourists; the data do not establish emirate performance, causality, profitability or future demand.", connector_config: { sheet: 3, header_row: 2, period: "2014-2025" } }),
  src({ id: "icp_golden_residency", name_en: "UAE Golden Residency System", name_ar: "منظومة الإقامة الذهبية", owner: "Federal Authority for Identity, Citizenship, Customs & Port Security", category: "residency", kind: "metadata", base_url: "https://u.ae/en/information-and-services/visa-and-emirates-id/residence-visas/golden-visa", docs_url: "https://u.ae/en/information-and-services/visa-and-emirates-id/residence-visas/golden-visa", access_status: "metadata_only", license: "Official government service information; verify current requirements with the competent authority.", notes: "Official pathway and evidence requirements, retained as a dated informational catalogue. Not an eligibility decision, application service, or approval guarantee." }),
  ...
  src({ id: "mof_open_data", name_en: "Ministry of Finance Open Data", name_ar: "البيانات المفتوحة لوزارة المالية", owner: "Ministry of Finance", category: "finance", kind: "metadata", base_url: "https://mof.gov.ae/en/home/", docs_url: "https://mof.gov.ae/en/open-data/", notes: "Statistical reports, dashboards, and publication plan." }),
  ...
  src({ id: "moce_open_data", name_en: "Ministry of Community Empowerment Open Data", name_ar: "البيانات المفتوحة لوزارة تمكين المجتمع", owner: "Ministry of Community Empowerment", category: "society", kind: "metadata", base_url: "https://www.moce.gov.ae/en/home", docs_url: "https://www.moce.gov.ae/en/open-data", notes: "Community, non-profit and social-sector open-data references." }),
  ...
  src({ id: "gcaa_current_aip_publications", name_en: "GCAA Current Aeronautical Publications Index", name_ar: "فهرس منشورات معلومات الطيران الحالي للهيئة العامة للطيران المدني", owner: "UAE General Civil Aviation Authority", category: "aviation", kind: "metadata", base_url: "https://www.gcaa.gov.ae/en/ais/AIPHtmlFiles/AIP/Current/UAE_AIP.html", docs_url: "https://www.gcaa.gov.ae/en/ais/AIPHtmlFiles/AIP/Current/UAE_AIP.html", license: "Official GCAA public aeronautical-information index; consult the authority source and applicable terms before reuse.", access_status: "live", notes: "Live official publication index parsed by the dedicated evidence service. Discovery only: not NOTAM, flight-planning data, operational guidance, regulatory interpretation, or a substitute for the current official AIP package." }),
  src({ id: "dewa_open_data", name_en: "Dubai Electricity and Water Authority Open Data", name_ar: "البيانات المفتوحة لهيئة كهرباء ومياه دبي", owner: "Dubai Electricity and Water Authority", category: "utilities", access_status: "blocked", kind: "metadata", base_url: "https://www.dewa.gov.ae/", docs_url: "https://www.dewa.gov.ae/en/about-us/open-data", notes: "Utilities open data. Automated health checks may be blocked by bot mitigation." }),
