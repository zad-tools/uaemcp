...
describe("OpenAPI contract", () => {
  it("publishes stable operation ids for SDK generation", () => {
    ...
    expect(operations).toEqual(expect.arrayContaining(["getCoverage", "listSources", "search", "getRecords", "getDatasetSchema", "listRecipes", "listIndicators", "getIndicator", "resolveEntities", "getTileJson", "spatialJoin", "getObservatoryReport", "listObservatoryIncidents", "getObservatorySource"]));
